...
public:
  ...
  /// clone function returns pointer to a new object of the Goal type,
  ...
  /// if Goal cell is pushed it will try not to move in pushed direction,
  /// and react with pushing cell, the Basic cell can force Goal cell to move
