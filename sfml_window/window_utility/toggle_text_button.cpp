...
sfml_window::ToggleTextButton &
sfml_window::ToggleTextButton::operator=(const ToggleTextButton &other) {
  if (&other == this)
    return *this;
...
sfml_window::ToggleTextButton::ToggleTextButton(
    const sfml_window::ToggleTextButton &other) {
  structure_ = other.structure_;
  background_ = other.background_;
  text_ = other.text_;
  hover_ = other.hover_;
...
sfml_window::ToggleTextButton *sfml_window::ToggleTextButton::Clone() {
  return new ToggleTextButton(*this);
}
...
void sfml_window::ToggleTextButton::SetButtonColor(const sf::Color &new_color) {
}
